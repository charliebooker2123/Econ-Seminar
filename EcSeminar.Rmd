...
hmap <- usmap + geom_polygon(data = mapheat, aes(fill = PatentRatio06), color = "black") + geom_polygon(color = "white", fill = NA) + theme_bw() + ditch_the_axes

hmap + scale_fill_gradient(trans = "log10")
